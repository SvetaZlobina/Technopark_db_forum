...
# Включаем асинхронный коммит в postgres
...
CMD service postgresql start && \
    ...
    \
    psql --command "CREATE DATABASE testdb WITH ENCODING 'UTF8';" && \
    psql -f $WORK/java-spring/sql/schema.sql testdb postgres && \
    java -Xms64m -Xmx128m -jar $WORK/java-spring/target/DBServer-1.0-SNAPSHOT.jar
